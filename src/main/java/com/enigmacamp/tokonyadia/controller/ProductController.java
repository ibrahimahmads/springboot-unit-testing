...
public class ProductController {
    ...
    public ResponseEntity<PageResponseWrapper<ProductResponse>> getAllProduct(@RequestParam(name = "page", defaultValue = "1") Integer page,
                                                                              ...
                                                                              @RequestParam(name = "sortBy", defaultValue = "productName")
                                                                                  String sortBy,
                                                                              @RequestParam(name = "direction", defaultValue = "ASC") String direction,
                                                                              @ModelAttribute ProductSearch productSearch){
        System.out.println("Model attribut" + productSearch);
    ...
    @PutMapping("{id}")
    public ProductResponse updateProduct(@RequestBody ProductRequest payload, @PathVariable UUID id){
